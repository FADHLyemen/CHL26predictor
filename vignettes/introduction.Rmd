...
To generate the CHL26 scores for the predictor, the R package simply requires an expression matrix as input. We'll first need to normalize the gene expression matrix:
